...
public class UserConvertor {
    public static UserDTO getUserDTO(User user) {
        ...
        return new UserDTO(user.getId(), rooms, user.getType(), user.getUsername(), user.getPassword(), AuthProvider.LOGIN);
    }
    ...
    public static User getUser(UserDTO user) {
        ...
        return new User(user.getId(), rooms, user.getType(), user.getUsername(), user.getPassword(), AuthProvider.LOGIN);
    }
}
